      ...
      <div className="flex items-center justify-center gap-16 flex-wrap md:p-12 rounded">
          <Card className="p-4 md:p-6 md:w-72 shadow-lg relative rounded m-2">
              ...
              <div className="card-content m-4">
                  <h2 className="uppercase text-center text-sm text-primary tracking-wider mb-2 md:font-semibold">{props.name}</h2>
                  <p className="md:text-xs text-[0.6rem] tracking-wider text-center text-accent-foreground">{props.position}</p>
              </div>
          </Card>
      </div>
  );
