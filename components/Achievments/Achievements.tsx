...
const goldAnimation = "https://lottie.host/fa9ce34a-f92e-401a-8ce6-0862941394fe/MhTkiixIXR.json";
const silverAnimation = "https://lottie.host/a141709b-c57c-42c9-9eaa-3cc55280ae13/SV2bPqESR2.json";
const bronzeAnimation = "https://lottie.host/d152d84e-059d-43c6-9cd6-39f40f62a106/l5lgH7DotG.json";
    ...
    return (
        <section id="achievements" className="flex justify-center px-4">
            <div className="container px-6 py-6">
                ...
                <div
                    className="place-items-center flex flex-wrap flex-row content-center justify-center items-center my-0 mx-auto relative touch-none gap-[32px]">
