      ...
      <section className="flex justify-center px-4">
          <div className="flex p-20 md:p-36">
              <div className="mr-auto place-self-center text-center sm:text-left lg:col-span-7">
                  <h1 className="max-w-2xl mb-4 text-4xl text-center sm:text-left font-extrabold tracking-tight leading-none md:text-5xl xl:text-6xl">Science and Technology Council </h1>
                  <p className="max-w-2xl mb-6 font-light text-center sm:text-left  lg:mb-8 md:text-lg lg:text-xl text-muted-foreground"> The official technical body of IIT (BHU) Varanasi</p>
